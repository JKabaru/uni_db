...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->hasRole('Admin')) {
            ...
            $staffmembers = Staffmember::latest()->get();

            return view('home', compact('parents','teachers','students','staffmembers'));
        ...
        } elseif ($user->hasRole('StaffMember')) {
                
            $staffmember = Staffmember::with(['user','department'])->findOrFail($user->staffmember->id); 

            return view('home', compact('staffmember'));
